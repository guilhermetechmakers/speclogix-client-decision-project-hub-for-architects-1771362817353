...
const mainNav = [
  ...
  { to: '/dashboard/templates-workflow-library', label: 'Templates & Workflow', icon: LayoutTemplate },
  { to: '/dashboard/templates-workflow-library', label: 'Templates & Workflow', icon: Workflow },
  ...
  { to: '/dashboard/performance-caching-backup', label: 'Performance, Caching & Backup', icon: HardDrive },
